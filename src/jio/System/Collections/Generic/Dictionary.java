...
public class Dictionary<TKey, TValue>
  ...
  public Dictionary() {
    try {
      javonetHandle = Javonet.New("Dictionary");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Dictionary(java.lang.Integer capacity) {
    try {
      javonetHandle = Javonet.New("Dictionary", capacity);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Dictionary(jio.System.Collections.Generic.IEqualityComparer<TKey> comparer) {
    try {
      javonetHandle = Javonet.New("Dictionary", comparer);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Dictionary(
      java.lang.Integer capacity, jio.System.Collections.Generic.IEqualityComparer<TKey> comparer) {
    try {
      javonetHandle = Javonet.New("Dictionary", capacity, comparer);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Dictionary(
    ...
    try {
      javonetHandle = Javonet.New("Dictionary", dictionary, comparer);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Dictionary(jio.System.Collections.Generic.IDictionary<TKey, TValue> dictionary) {
    try {
      javonetHandle = Javonet.New("Dictionary", dictionary);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

...
public class ReadOnlyCollection<T>
  ...
  public ReadOnlyCollection(jio.System.Collections.Generic.IList<T> list) {
    try {
      javonetHandle = Javonet.New("ReadOnlyCollection", list);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.Boolean Contains(T value) {
    try {
      return javonetHandle.generic(getGetObjectName(value)).invoke("Contains", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return false;
    }
  ...
  public java.lang.Integer IndexOf(T value) {
    try {
      return javonetHandle.generic(getGetObjectName(value)).invoke("IndexOf", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return 0;
    }

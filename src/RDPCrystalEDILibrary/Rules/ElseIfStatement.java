...
public class ElseIfStatement extends Node {
  ...
  public Condition getCondition() {
    try {
      return new Condition((NObject) javonetHandle.get("Condition"));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public void setTrue(Node value) {
    try {
      javonetHandle.set("True", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Node getTrue() {
    try {
      return new Node((NObject) javonetHandle.get("True"));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public Node getFalse() {
    try {
      return new Node((NObject) javonetHandle.get("False"));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public ElseIfStatement(java.lang.String text, java.lang.Integer depth) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("ElseIfStatement", text, depth);
  ...
  public ElseIfStatement(NObject handle) {
    super(handle);

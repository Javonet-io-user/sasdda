...
public abstract class DocumentSegment {
  ...
  public DocumentSegment() {
    try {
      javonetHandle = Javonet.New("DocumentSegment");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public DocumentSegment(java.lang.String name) {
    try {
      javonetHandle = Javonet.New("DocumentSegment", name);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public DocumentSegment(NObject handle) {
  ...
  public void Write(WriteArguments writeArgs) {
    try {
      javonetHandle.invoke("Write", writeArgs);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

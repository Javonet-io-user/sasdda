...
public class HealthCareClaimStatus extends CompositeElement {
  ...
  public HealthCareClaimStatus() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("HealthCareClaimStatus");
  ...
  public HealthCareClaimStatus(NObject handle) {
    super(handle);

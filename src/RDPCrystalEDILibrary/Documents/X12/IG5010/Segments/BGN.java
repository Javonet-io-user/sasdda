...
public class BGN extends DocumentSegment {
  ...
  public java.lang.String getTransactionSetPurposeCode() {
    try {
      return (java.lang.String) javonetHandle.get("TransactionSetPurposeCode");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return "";
    }
  ...
  public void setTimeCode(java.lang.String value) {
    try {
      javonetHandle.set("TimeCode", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getTimeCode() {
    try {
      return (java.lang.String) javonetHandle.get("TimeCode");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return "";
    }
  ...
  public java.lang.String getTransactionTypeCode() {
    try {
      return (java.lang.String) javonetHandle.get("TransactionTypeCode");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return "";
    }
  ...
  public void setSecurityLevelCode(java.lang.String value) {
    try {
      javonetHandle.set("SecurityLevelCode", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getSecurityLevelCode() {
    try {
      return (java.lang.String) javonetHandle.get("SecurityLevelCode");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return "";
    }

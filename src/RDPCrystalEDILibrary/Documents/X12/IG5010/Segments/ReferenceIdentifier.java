...
public class ReferenceIdentifier extends CompositeElement {
  ...
  public java.lang.String getReferenceIdentificationQualifier1() {
    try {
      return (java.lang.String) javonetHandle.get("ReferenceIdentificationQualifier1");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return "";
    }
  ...
  public java.lang.String getReferenceIdentificationQualifier2() {
    try {
      return (java.lang.String) javonetHandle.get("ReferenceIdentificationQualifier2");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return "";
    }
  ...
  public java.lang.String getReferenceIdentificationQualifier3() {
    try {
      return (java.lang.String) javonetHandle.get("ReferenceIdentificationQualifier3");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return "";
    }
  ...
  public ReferenceIdentifier() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("ReferenceIdentifier");
